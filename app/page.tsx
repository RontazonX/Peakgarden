...
export default function SmartGardenApp() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    if (username.length > 2 && password.length > 2) {
      ...
      setLoginError('Username and password must be at least 3 characters.');
    }
  };
          ...
          >
            <div className="w-full max-w-md bg-white rounded-3xl shadow-xl overflow-hidden border border-slate-100">
              <div className="bg-emerald-600 p-8 text-center">
                ...
                <h1 className="text-2xl font-bold text-white">Smart Garden</h1>
              ...
              <form onSubmit={handleLogin} className="p-8 space-y-6">
                ...
                <button 
                  type="submit"
                  className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-medium py-3 rounded-xl transition-colors shadow-sm shadow-emerald-600/20"
                >
                  Sign In
                </button>
              </form>
